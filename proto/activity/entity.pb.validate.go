...
// Validate checks the field values on CloudTrailAttribute with the rules
// defined in the proto definition for this message. If any rules are
// violated, an error is returned.
func (m *CloudTrailAttribute) Validate() error {
	if m == nil {
		return nil
	}
...
// CloudTrailAttributeValidationError is the validation error returned by
// CloudTrailAttribute.Validate if the designated constraints aren't met.
type CloudTrailAttributeValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CloudTrailAttributeValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CloudTrailAttributeValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CloudTrailAttributeValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CloudTrailAttributeValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CloudTrailAttributeValidationError) ErrorName() string {
	return "CloudTrailAttributeValidationError"
}

// Error satisfies the builtin error interface
func (e CloudTrailAttributeValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCloudTrailAttribute.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CloudTrailAttributeValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CloudTrailAttributeValidationError{}
