...
var file_aws_entity_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x22, 0xc1, 0x01, 0x0a, 0x13, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63,
	...
	0x72, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x42, 0x2c, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_aws_entity_proto_goTypes = []interface{}{
	...
	(*AWSRelDataSource)(nil),    // 1: aws.aws.AWSRelDataSource
	(*AWSForUpsert)(nil),        // 2: aws.aws.AWSForUpsert
	(*DataSource)(nil),          // 3: aws.aws.DataSource
	(*DataSourceForAttach)(nil), // 4: aws.aws.DataSourceForAttach
}
