...
func TestIsMatchAccountIDArn(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			arn:       "arn:aws:iam::556822360006:role/RISKEN",
			accountID: "556822360006",
			want:      true,
		},
		{
		...
		},
		{
			...
			arn:       "arn:aws:iam::556822360006:role/123456789012",
			accountID: "123456789012",
			want:      false,
		},
		{
			name:      "NG invalid arn",
			arn:       "arn:aws:iam556822360006:role/123456789012",
			accountID: "556822360006",
			want:      false,
		},
	}
